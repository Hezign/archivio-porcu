export const fr = {
  // ──────── UI globale (header, footer, nav) ────────
  ui: {
    siteTitle: 'Archivio Porcu',
    siteSubtitle: 'Sardegna · Archivio',
    topbar: 'Archivio Porcu · Projet culturel & généalogique',
    nav: {
      home: 'Accueil',
      name: 'Le nom',
      sardinia: 'Sardaigne',
    ...
    footerSources: 'Sources principales',
    footerEthical:
    ...
    legalLinks: {
      ...
      removal: 'Retrait / rectification',
    },
    chapter: 'Chapitre',
    chapters: ['Premier', 'Second', 'Troisième', 'Quatrième', 'Cinquième', 'Sixième'],
    next: 'Suivant',
  ...
  home: {
    ...
    diasporaTitle3: 'aux mines',
    diasporaTitle4: 'de Lorraine',
    diasporaP1:
  ...
  // ──────── Page Le nom ────────
  name: {
    metaTitle: 'Le nom Porcu · Étymologie et répartition',
    chapterTitle: 'Le nom Porcu',
    chapterSub: "Étymologie, attestations historiques et géographie d'un patronyme sarde ancien.",
    etymologyEyebrow: 'Étymologie',
    ...
    cartoTitle1: 'Cartographie des',
    cartoTitle2: 'communes',
    cartoLead:
      "Le patronyme Porcu est attesté dans un faisceau de communes bien identifiées. Chaque point sur la carte représente une zone où les registres font apparaître le nom avec une fréquence significative.",
    indexEyebrow: 'Index',
    indexTitle: 'Les neuf communes de référence',
    diasporaSectionEyebrow: 'Diaspora documentée',
    diasporaSectionTitle1: 'Des villages',
    diasporaSectionTitle2: 'au bassin minier',
    diasporaSectionP1:
      "L'histoire du nom Porcu ne s'arrête pas aux côtes sardes. Dans les années 1950, alors que la France accueille massivement des travailleurs étrangers pour ses industries extractives, plusieurs familles Porcu rejoignent Bousbach et Forbach, au cœur du bassin houiller lorrain.",
    diasporaSectionP2:
      "Comme d'autres communautés italiennes et nord-africaines, les Sardes installent progressivement une présence durable, maintenant des liens avec l'île d'origine. Une réunion familiale Porcu est documentée dans la presse locale en 2018, témoignant de la vivacité de cette mémoire collective.",
    diasporaSectionP3:
    ...
    map: {
      ...
      title: 'Attestation du patronyme',
      detailEyebrow: 'Commune sélectionnée',
      detailScale: 'Échelle approx.',
      detailPriority: '✦ priorité',
      legendPriority: 'Commune prioritaire',
      legendAttest: 'Attestation historique',
      legendHint: 'Cliquez sur un point pour en savoir plus',
    },
  },

  // ──────── Page Sardaigne ────────
  sardinia: {
    metaTitle: 'Sardaigne · Identité, culture et drapeau',
    ...
    flagNewEyebrow: 'Version officielle',
    flagNewTitle: 'Bandeau relevé',
    ...
    flagStats: [
      { num: 'XIVᵉ', label: 'Première attestation' },
      { num: 'XIXᵉ', label: 'Diffusion « yeux bandés »' },
      { num: '1999', label: 'Réforme officielle' },
      { num: '4', label: 'Maures' },
    ],
    langEyebrow: 'Langue & culture',
    langTitle1: 'Une île,',
    langTitle2: 'plusieurs langues',
    langs: [
      { name: 'Sardo campidanais', zone: 'Sud et centre-sud', note: 'Parlé dans le Campidano, Cagliari, Sarrabus.' },
      { name: 'Sardo logudorien', zone: 'Centre et nord', note: 'Variante considérée comme plus conservatrice, au cœur de la Barbagia.' },
      { name: 'Gallurais', zone: 'Nord-est', note: 'Variante proche du corse méridional, parlée en Gallura.' },
      { name: 'Sassarais', zone: 'Sassari', note: "Variante d'influence toscane, héritage des liens médiévaux avec Pise." },
    ],
    timeEyebrow: 'Repères',
  ...
  // ──────── Page Banditisme ────────
  banditry: {
    metaTitle: 'Le banditisme sarde · Contexte historique',
    chapterTitle1: 'Le banditisme',
    chapterTitle2: 'sarde',
    chapterSub: "Phénomène rural, codes d'honneur et géographie d'une résistance archaïque.",
    geoEyebrow: 'Géographie',
    geoTitle1: 'La',
    geoTitle2: 'Barbagia',
    ...
    codeRules: [
      ...
      { t: 'Paghesa', d: 'Procédure de réconciliation formelle mettant fin au cycle vindicatif.' },
    ],
    figEyebrow: 'Figures',
    ...
    fig1Text:
      "« Grazianeddu », bandit emblématique de l'Orgosolo des années 1960-1970, célèbre pour ses évasions multiples. Sa trajectoire incarne l'ambiguïté du banditisme sarde : figure populaire dans certains milieux, tout en accumulant les condamnations judiciaires. Son nom est inséparable de la période médiatique des enlèvements.",
    fig2Date: 'Arzana, 1895 – 1928',
    fig2Name: 'Samuele Stocchino',
    fig2Text:
      "Surnommé « la tigre d'Ogliastra », figure majeure du banditisme des années 1920, lié à une vendetta familiale devenue tragédie collective. Il représente la forme classique, archaïque, du bandit pastoral antérieur au tournant kidnapping.",
    distEyebrow: 'Point de vigilance historiographique',
    distTitle: 'Banditisme sarde ≠ mafia structurée',
    distP1:
  ...
  anonima: {
    ...
    chronoEyebrow: 'Chronologie',
    chronoTitle1: 'De la montagne',
    chronoTitle2: 'au procès-verbal',
    chronoLead:
      "Une lecture séquentielle, du banditisme archaïque du XIXᵉ siècle à l'extinction du phénomène à la fin des années 1990.",
    ...
    sources: [
      ...
      { t: 'Presse locale', d: 'Emeroteca Sarda, Le Monde' },
      { t: 'Archives judiciaires', d: 'DIA, Portale Antimafia' },
      { t: 'Ouvrages spécialisés', d: 'Casalunga, Domenech' },
    ],
    transitionQuote:
    ...
    timelineLegend: 'Catégories',
    timelineCats: { contexte: 'Contexte historique', anonima: 'Anonima Sarda', figure: 'Figure' },
  },

  // ──────── Page Généalogie ────────
  genealogy: {
    metaTitle: 'Généalogie Porcu · Arbre, méthode, contribution',
    chapterTitleSub: 'Chapitre sixième · dernier',
    ...
    archivesTitle1: 'Les',
    archivesTitle2: 'portes',
    archivesTitle3: "d'entrée",
    archivesLead:
      "Chacune de ces ressources correspond à une étape distincte du protocole. La plupart sont gratuites ; toutes demandent patience et rigueur de lecture paléographique.",
    archives: [
      { nom: 'Antenati', org: 'Archivi di Stato · Italie', desc: "Portail officiel italien des archives d'état civil numérisées. Registres communaux consultables librement, souvent jusqu'au XIXᵉ siècle.", cat: 'Italie · gratuit' },
      { nom: 'FamilySearch', org: 'Église de Jésus-Christ des SDJ', desc: 'Base mondiale avec inventaires sardes importants. Accès gratuit après création de compte.', cat: 'Mondial · gratuit' },
      { nom: 'Geneanet', org: 'Communauté généalogique', desc: "Arbres collaboratifs et indexations, utile pour repérer d'autres branches Porcu déjà travaillées.", cat: 'Collaboratif · freemium' },
      { nom: 'Mairies sardes', org: 'Comune di ...', desc: "Demande directe d'acte (richiesta d'atto) par courrier ou email. Réponse gratuite pour les descendants directs.", cat: 'Sardaigne · gratuit' },
      { nom: 'Archives paroissiales', org: 'Diocèses de Sardaigne', desc: 'Registres antérieurs à 1866 (mariages, baptêmes, sépultures). Accès sur demande au prêtre responsable.', cat: 'Sardaigne · variable' },
      { nom: 'Archives départementales', org: 'Moselle, France', desc: "Pour la branche lorraine : actes d'état civil, registres d'immigration, recensements miniers.", cat: 'France · gratuit' },
    ],
    ethicalQuote:
    ...
    tree: {
      ...
      birth: 'Naissance',
      death: 'Décès',
      goldenRuleEyebrow: 'Double règle',
      goldenRule1: 'Aucune filiation sans acte probant.',
      goldenRule2: 'Aucune personne vivante sans consentement écrit.',
      goldenRuleSub:
        "La rigueur documentaire prime sur l'hypothèse séduisante. Chaque filiation doit reposer sur un acte de naissance, de mariage ou de décès consultable. Les personnes vivantes ne sont jamais publiées sans leur accord exprès, conformément au RGPD.",
    },
    contrib: {
      eyebrow: 'Appel à contribution',
      title: 'Vous portez le nom, avez un ancêtre Porcu, ou détenez des documents de famille ?',
      lead:
        "Ce projet est collectif par nature. Les livrets de famille, photographies anciennes, correspondances, actes d'émigration ou simples souvenirs sont précieux pour reconstituer les branches de la diaspora sarde.",
      firstName: 'Prénom',
      lastName: 'Nom',
      email: 'Courriel',
      relation: 'Lien avec le nom Porcu',
      relationOpts: [
        'Je porte le nom Porcu',
        'Ancêtre / parent direct nommé Porcu',
        'Alliance familiale (mariage)',
        'Chercheur / généalogiste',
        'Simple intérêt pour la Sardaigne',
      ],
      message: 'Votre message',
      messagePlaceholder: "Commune sarde d'origine, ancêtres connus, documents disponibles…",
      gdprEyebrow: 'Informations RGPD',
      gdpr1Label: 'Finalité :',
      gdpr1: 'répondre à votre message et échanger dans le cadre de la recherche généalogique Porcu.',
      ...
      consent:
        "J'accepte que mes données soient traitées dans le cadre strict de la recherche généalogique Porcu, conformément à la",
      consentLink1: 'politique de confidentialité',
      consent2: '. Je comprends que je peux retirer mon consentement à tout moment via la',
      consentLink2: 'page de retrait',
      submit: 'Envoyer ma contribution',
      submitConfirm:
        'Merci ! Ce formulaire est en cours de finalisation. Votre contribution sera transmise dès la mise en ligne définitive.',
    },
    legalNotice: {
      eyebrow: "Politique de confidentialité de l'arbre",
      text:
        "Les personnes vivantes ne sont jamais publiées publiquement sans leur consentement écrit explicite. Seules les personnes décédées peuvent apparaître dans l'arbre, conformément au RGPD et aux délais légaux d'accès à l'état civil (75 ans pour naissances et mariages, 25 ans pour décès en France).",
      cta: 'Demander une rectification ou un retrait →',
    },
  },
  ...
  components: {
    timeline: {
      legend: 'Catégories',
      cats: { contexte: 'Contexte historique', anonima: 'Anonima Sarda', figure: 'Figure' },
    },
    legalNoticeStrong: {
      eyebrow: 'Avertissement éditorial',
      text:
        "Ce chapitre documente un phénomène historique de la Sardaigne intérieure. Il ne vise ni à romantiser le banditisme, ni à l'associer à une population dans son ensemble. Aucune affirmation concernant des personnes vivantes ou des liens entre le patronyme Porcu et des activités criminelles n'est publiée sans base documentaire sérieuse. Les porteurs actuels du nom ne sont, en l'état des recherches, pas liés aux groupes évoqués.",
      cta: 'Toute personne concernée peut exercer son droit de rectification ou de retrait.',
    },
  },
  ...
  legal: {
    mentions: {
      metaTitle: 'Mentions légales · Archivio Porcu',
      eyebrow: 'Informations légales',
      title1: 'Mentions',
      title2: 'légales',
      sub: "Conformément aux dispositions de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique.",
      s1Eyebrow: 'Éditeur du site',
      s1Title: 'Responsable de la publication',
      s1Text:
      ...
      s3Text1:
        "Ce site a une vocation culturelle, historique et généalogique. Les informations publiées sont issues de recherches documentaires et familiales. Aucune affirmation concernant des personnes vivantes ou des liens avec des activités criminelles n'est publiée sans base documentaire sérieuse. Toute personne concernée peut demander une",
      s3Link: 'rectification ou un retrait',
      s4Eyebrow: 'Propriété intellectuelle',
      s4Title: "Droits d'auteur",
      s4P1:
        "Les textes originaux publiés sur ce site sont la propriété de leur auteur. Les citations, références bibliographiques et extraits d'archives sont utilisés dans le cadre du droit de citation à des fins pédagogiques et patrimoniales, avec mention explicite des sources.",
      s4P2:
        "Aucune photographie de famille, lettre privée ou document d'archive n'est publiée sans autorisation écrite de son détenteur légitime. Tout usage non autorisé signalé sera corrigé dans les plus brefs délais.",
      s5Eyebrow: 'Liens externes',
      s5Title: 'Sites tiers',
      s5Text:
        "Ce site peut contenir des liens vers des sites externes (archives publiques, portails généalogiques, presse en ligne). L'éditeur n'exerce aucun contrôle sur le contenu de ces sites tiers et ne saurait être tenu responsable des informations qui y sont publiées.",
      s6Eyebrow: 'Droit applicable',
      s6Title: 'Juridiction',
      s6Text:
      ...
      navRemoval: 'Demande de retrait →',
      navBack: 'Retour',
      navHome: 'Accueil →',
    },
    privacy: {
      metaTitle: 'Politique de confidentialité · Archivio Porcu',
      eyebrow: 'RGPD · Règlement UE 2016/679',
      title1: 'Politique de',
      title2: 'confidentialité',
      sub: 'Comment les données personnelles sont collectées, utilisées et protégées sur ce site.',
      intro:
        "Ce site respecte le Règlement général sur la protection des données (RGPD) ainsi que la loi française « Informatique et Libertés » modifiée. La présente politique explique de manière transparente quelles données sont collectées, dans quel cadre, et quels sont vos droits.",
      s1Eyebrow: '§ 1',
      s1Title: 'Données collectées',
      s1Text:
        "Les seules données personnelles collectées par ce site sont celles que vous nous transmettez volontairement via le formulaire de contribution généalogique : prénom, nom, adresse email, lien déclaré avec le nom Porcu, et le contenu de votre message. Aucune donnée n'est collectée à votre insu : pas de cookie de suivi, pas de pixel publicitaire, pas d'analyse comportementale.",
      s2Eyebrow: '§ 2',
      s2Title: 'Finalités du traitement',
      s2Text:
        "Vos données sont utilisées exclusivement pour : (1) répondre à votre message et échanger dans le cadre de la recherche généalogique Porcu ; (2) reconstituer, avec votre accord exprès et préalable, des branches de l'arbre généalogique. Aucune publication nominative n'est effectuée sans votre consentement écrit explicite.",
      s3Eyebrow: '§ 3',
      s3Title: 'Base légale',
      s3Text:
        "Le traitement de vos données repose sur votre consentement explicite (article 6.1.a du RGPD), recueilli via la case à cocher du formulaire. Vous pouvez retirer ce consentement à tout moment.",
      s4Eyebrow: '§ 4',
      s4Title: 'Durée de conservation',
      s4Text:
        "Vos données sont conservées au maximum 3 ans à compter de notre dernier échange. À l'issue de cette période, elles sont effacées sauf demande explicite de votre part de prolonger la collaboration.",
      s5Eyebrow: '§ 5',
      s5Title: 'Vos droits',
      s5Text:
      ...
      s5After:
        "Pour exercer ces droits, utilisez la page de retrait ou écrivez directement à l'adresse email de contact (voir mentions légales).",
      s6Eyebrow: '§ 6',
      s6Title: 'Réclamations',
      s6Text:
        "Si vous estimez, après nous avoir contactés, que vos droits ne sont pas respectés, vous pouvez introduire une réclamation auprès de la CNIL (France) ou du Garante per la protezione dei dati personali (Italie).",
      s7Eyebrow: '§ 7',
      s7Title: 'Cookies',
      s7Text:
      ...
      s8Text:
        "La présente politique peut être mise à jour pour refléter des évolutions légales ou techniques. La date de dernière mise à jour figure ci-dessous. Toute modification substantielle vous sera signalée par email si vous nous avez transmis vos coordonnées.",
      lastUpdate: 'Dernière mise à jour : 25 octobre 2026',
    },
    removal: {
      metaTitle: 'Demande de retrait ou de rectification · Archivio Porcu',
      eyebrow: 'Droits RGPD · Articles 16 & 17',
      title1: 'Retrait ou',
      title2: 'rectification',
      sub: 'Si une information publiée vous concerne ou concerne un proche, vous pouvez demander sa correction ou sa suppression.',
      intro:
        "Ce site s'engage à traiter toute demande de rectification ou de retrait dans les meilleurs délais (réponse sous 30 jours conformément au RGPD). Les demandes peuvent porter sur : une mention nominative, une photographie, un acte d'état civil, une affirmation factuelle, un lien dans l'arbre généalogique, ou toute information vous concernant directement ou concernant un parent décédé dont vous êtes ayant droit.",
      ...
      types: [
        'Rectification (correction d\'une information)',
        'Retrait (suppression complète)',
        'Demande d\'accès aux données',
        'Question préalable',
      ],
      pageUrl: 'URL de la page concernée',
      pageUrlPlaceholder: 'Lien complet de la page où figure l\'information',
      details: 'Détail de la demande',
      detailsPlaceholder: "Décrivez précisément l'information visée et la modification souhaitée. Si vous demandez un retrait au nom d'un proche, précisez votre lien de parenté.",
      proof: 'Justificatif (optionnel mais recommandé)',
      proofText:
        "Pour les demandes concernant un parent décédé, un justificatif d'ayant droit (livret de famille, acte notarié) peut être joint par retour d'email après réception de votre demande.",
      submit: 'Envoyer ma demande',
      confirm:
        "Merci. Votre demande sera examinée et une réponse vous sera apportée sous 30 jours conformément au RGPD. En cas de demande recevable, la modification ou suppression sera effectuée dans les meilleurs délais.",
      altEyebrow: 'Voie alternative',
      altTitle: 'Par email',
      altText:
        "Vous pouvez également formuler votre demande directement par email à l'adresse de contact figurant dans les mentions légales. Précisez : votre identité, l'objet de la demande, et la page concernée.",
    },
  },
};
